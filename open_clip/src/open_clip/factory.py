...
from .model import CLIP, CustomTextCLIP, VideoCLIP, convert_weights_to_lp, convert_to_custom_text_state_dict,\
...
def create_model(
    ...
    if getattr(model.CLIP.visual, 'image_size', None) is not None:
        # use image_size set on model creation (via config or force_image_size arg)
        force_preprocess_cfg['size'] = model.CLIP.visual.image_size
    set_model_preprocess_cfg(model.CLIP, merge_preprocess_dict(preprocess_cfg, force_preprocess_cfg))
...
def create_model_and_transforms(
    ...
    pp_cfg = PreprocessCfg(**model.CLIP.visual.preprocess_cfg)
